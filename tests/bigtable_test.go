...
func requireBigtableVars(t *testing.T) map[string]any {
	switch "" {
...
func TestBigtableSimpleToolEndpoints(t *testing.T) {
	sourceConfig := requireBigtableVars(t)
